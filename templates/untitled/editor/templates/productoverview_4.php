...
<body class="data-control-id-25 bootstrap bd-body-4 bd-pagebackground">
...
?>
		...
		<div class="bd-containereffect-5 container data-control-id-341">
<div class="bd-contentlayout-4  bd-sheetstyles data-control-id-343">
    <div class="bd-container-inner">
 ...
 <?php renderTemplateFromIncludes('sidebar_area_3'); ?>
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class="data-control-id-946525 bd-layoutitemsbox-21 bd-flex-wide">
    <div class="data-control-id-866 bd-content-3">
    <div class="bd-container-inner">
        <?php
