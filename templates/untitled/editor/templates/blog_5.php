...
<body class="data-control-id-55 bootstrap bd-body-5 bd-pagebackground">
...
?>
		...
		<div class="data-control-id-1068464 bd-stretchtobottom-4 bd-stretch-to-bottom" data-control-selector=".bd-contentlayout-5">
<div class="bd-contentlayout-5  bd-sheetstyles data-control-id-355">
    <div class="bd-container-inner">
 ...
 <?php renderTemplateFromIncludes('sidebar_area_3'); ?>
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class="data-control-id-946538 bd-layoutitemsbox-22 bd-flex-wide">
