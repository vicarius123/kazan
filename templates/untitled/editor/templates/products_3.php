...
<body class="data-control-id-19 bootstrap bd-body-3 bd-pagebackground">
...
?>
		...
		<div class="bd-contentlayout-3 bd-sheetstyles data-control-id-331">
    <div class="bd-container-inner">
 ...
 <?php renderTemplateFromIncludes('sidebar_area_3'); ?>
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class="data-control-id-946512 bd-layoutitemsbox-19 bd-flex-wide">
