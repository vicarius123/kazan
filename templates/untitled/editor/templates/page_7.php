...
<body class="data-control-id-31 bootstrap bd-body-7 bd-pagebackground">
...
<div class="bd-contentlayout-7 bd-page-width   bd-sheetstyles data-control-id-379">
    <div class="bd-container-inner">
 ...
 <?php renderTemplateFromIncludes('sidebar_area_1'); ?>
            <div class="bd-flex-horizontal bd-flex-wide">
                ...
                <div class="bd-flex-vertical bd-flex-wide">
                    ...
                    <div class="data-control-id-946558 bd-layoutitemsbox-24 bd-flex-wide">
