...
$skip = false;
?>
<div class="data-control-id-237857 bd-horizontalmenu clearfix">
    <div class="bd-container-inner">
        <?php
$mIconClassName = '';
ob_start();
?>
<li class="data-control-id-237859 bd-menuitem-54 {submenu_icon_only}">
<?php 
$menuStartItem = ob_get_clean();
ob_start();
?>

<ul class="data-control-id-237858 bd-menu-54 nav navbar-left nav-pills<?php echo $class_sfx;?>" <?php echo $tag_id; ?>>
<?php
$bHMenu = ob_get_clean();
$eHMenu = "</ul>";
?>
...
ob_start();
?>
<li class="data-control-id-237878 bd-menuitem-55">
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    if ($item->deeper) {
        ...
        ?>
        <div class="bd-menu-55-popup"><ul class="data-control-id-237877 bd-menu-55">
        <?php
    }
