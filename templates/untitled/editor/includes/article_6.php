<?php function article_6($data) {
    ...
    <?php endif; ?>
		...
		<div class="data-control-id-1547 bd-layoutcontainer-22 bd-columns
...
<?php endif; ?></div></div>
		...
		<div class="data-control-id-1580 bd-postcontent-6 bd-tagstyles " itemprop="articleBody">
    <?php
        $attr = '';
    ...
    <div class="bd-container-inner"<?php echo $attr; ?>>
		...
		<div class="data-control-id-1593 bd-layoutcontainer-23 bd-columns
