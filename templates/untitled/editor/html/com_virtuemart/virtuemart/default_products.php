...
?>
	...
	<div data-slider-id="products_slider" class="data-control-id-2825 bd-productsslider-1" data-elements-per-row="<?php echo VmConfig::get ( 'homepage_products_per_row', 3 ); ?>">
	    <div class="bd-container-inner">
            <div class="data-control-id-200751 bd-block">
                <div class="data-control-id-203130 bd-blockheader bd-tagstyles">
                    <h4><?php echo $productTitle; ?></h4>
                </div>
                <div class="data-control-id-203162 bd-blockcontent bd-tagstyles shape-only">
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = 'data-control-id-280 bd-productbuy-1 bd-button';
    ?>
