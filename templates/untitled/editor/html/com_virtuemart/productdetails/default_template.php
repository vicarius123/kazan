...
?>
<div class="data-control-id-3571 bd-productoverview vm-product-item">
    <div class="data-control-id-2366 bd-layoutcontainer-29 bd-columns
    
    ">
    <div class="bd-container-inner">
        <div class="container-fluid">
            <div class="row">
                <div class="data-control-id-2362 bd-columnwrapper-64 
 col-md-8">
    <div class="bd-layoutcolumn-64 bd-column" ><div class="bd-vertical-align-wrapper"><h2 class="data-control-id-2273 bd-productoverviewtitle-1">
                ...
                <?php endif ?>
                    ...
                    <a class="data-control-id-2263 bd-productimage-7"
                       ...
                       href="<?php echo JURI::root() . $image->file_url; ?>">
                        <img class="data-control-id-2262 bd-imagestyles-20" src="<?php echo $thumbUrl; ?>" />
                    </a>
...
<?php endif ?></div></div>
		...
		<div class="data-control-id-2364 bd-columnwrapper-65 
 col-md-4">
...
<div class="data-control-id-2342 bd-productprice-5 product-prices">
    ...
    <span class="data-control-id-2306 bd-container-36 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table salesPrice">
        <?php echo $html; ?>
    </span>
    ...
    <span class="data-control-id-2340 bd-container-37 bd-tagstyles bd-custom-blockquotes bd-custom-button bd-custom-image bd-custom-table basePrice">
        <?php echo $html; ?>
    </span>
</div>
    <?php } ?>
...
<div class="data-control-id-2351 bd-productrating-1">
    ...
    <div class='data-control-id-2350 bd-rating'>
        ...
        <span class='data-control-id-2349  bd-icon bd-icon-3 <?php echo $active ?>'></span>
        <?php endfor; ?>
    </div>
    <?php
            }
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = 'data-control-id-2360 bd-productbuy-4 bd-button';
    ?>
