...
<div class="data-control-id-3392 bd-products">
    ...
    <div class="bd-container-inner">
        <div class="data-control-id-1949 bd-layoutcontainer-27 bd-columns
...
<?php endif; ?>
		...
		<div class="data-control-id-16398 bd-layoutcontainer-41 bd-columns
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = 'data-control-id-1853 bd-productbuy-2 bd-button';
    ?>
...
<?php endif; ?>
    ...
    <div class="separated-item-6 col-md-12 list vm-product-item"<?php if ('list' !== $activeLayoutName): ?> style="display: none;"<?php endif ?>>
        <div class="data-control-id-3384 bd-griditem-6">
            <div class="data-control-id-35507 bd-layoutcontainer-26 bd-columns
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        // todo output customfields
        $buttonDataAttrs = '';
        $classNames = 'data-control-id-1941 bd-productbuy-3 bd-button';
    ?>
    <?php if (!VmConfig::get('use_as_catalog', 0)) : ?>
        <?php
            $quantity = 1;
