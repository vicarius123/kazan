...
<div class="data-control-id-627702 bd-grid-15">
...
?>
 ...
 col-md-2">
    <div class="bd-layoutcolumn-3 bd-column" ><div class="bd-vertical-align-wrapper"><a class="data-control-id-112 bd-itemeditlink-1" href="<?php echo $product['href']; ?>">
    <span class="
 bd-icon-9 bd-icon data-control-id-111"></span>
</a>
 ...
 col-md-4">
    <div class="bd-layoutcolumn-4 bd-column" ><div class="bd-vertical-align-wrapper"><a href="<?php echo $cartHref; ?>" class="data-control-id-186 bd-button">
    <?php echo $cartText; ?>
</a></div></div>
</div>
 ...
 col-md-8">
    <div class="bd-layoutcolumn-5 bd-column" ><div class="bd-vertical-align-wrapper"><a href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=cart&task=checkout_task'); ?>" class="data-control-id-191 bd-button">
