...
?>
<form role="form" class="data-control-id-2793 bd-searchwidget-2 form-inline" name="search" action="<?php echo JRoute::_('index.php');?>" method="post">
    <div class="bd-container-inner">
        ...
        <div class="bd-search-wrapper">
                ...
                <div class="bd-input-wrapper">
                    <input name="searchword" id="mod-search-searchword" maxlength="<?php echo $maxlength; ?>" class="data-control-id-2784 bd-bootstrapinput-2 form-control"
                ...
                <div class="bd-button-wrapper">
                    <input type="submit" value="<?php echo $button_text ?>" class="data-control-id-2783 bd-button <?php echo $moduleclass_sfx ?>" onclick="this.form.searchword.focus();"/>
                </div>
        </div>
        <script>
