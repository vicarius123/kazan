...
<div class="data-control-id-2779 bd-vmenu-1" data-responsive-menu="true" data-responsive-levels="">
    <div class="data-control-id-2778 bd-block-2 <?php echo $params->get('moduleclass_sfx'); ?>">
        <?php if ($hasCaption) : ?>
...
<?php $subMenuStartItem = ob_get_clean(); ?>
    ...
    ?>	
        <div class="bd-menu-24-popup">
                ...
                <ul class="data-control-id-200694 bd-menu-24 nav ">
    <?php
    }
