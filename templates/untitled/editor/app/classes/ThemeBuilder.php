...
class ThemeBuilder
{
    ...
    private function _buildManifest($themeDir)
    {
        ...
        foreach ($elements as $element) {
            ...
            $sysPositionsContent .= 'TPL_' . strtoupper($this->_templateName) . '_POSITION_' . strtoupper($element) .
                '=' . '"' . $element . '"' . PHP_EOL;
        }
        // create language file for system positions
        Helper::writeFile($themeDir . '/language/en-GB/en-GB.tpl_' . $this->_templateName . '.sys.ini', $sysPositionsContent);
        ...
        if (JComponentHelper::getComponent('com_virtuemart', true)->enabled == '1') {
            ...
            $defaults = array("", "", "12", "");
            $values1 = array('Default', '1', '2', '3', '4', '6', '12');
            $values2 = array('', '24', '12', '8', '6',  '4', '2');
