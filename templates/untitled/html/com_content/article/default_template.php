...
<div class=" bd-blog-2 <?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Article">
    
    <?php $pageHeading = strlen($article->pageHeading) ? $component->pageHeading($article->pageHeading) : ''; ?>
        <?php if ($pageHeading) : ?>
            <h2 class=" bd-container-4 bd-tagstyles"><?php echo $pageHeading; ?></h2>
        <?php endif; ?>
    <div class=" bd-grid-1">
      <div class="container-fluid">
        <div class="separated-grid row">
