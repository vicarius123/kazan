...
abstract class ArtxContentArticleBase
{
    ...
    public function categories($parentCategory, $parentCategoryLink, $category, $categoryLink)
    {
        ...
        if (strlen($parentCategory)) {
          echo '<span class="post-metadata-category-parent"' . (strlen($parentCategoryLink) ? '' : ' itemprop="genre"') . '>';
        ...
        if (strlen($category)) {
          echo '<span class="post-metadata-category-name"' . (strlen($categoryLink) ? '' : ' itemprop="genre"') . '>';
