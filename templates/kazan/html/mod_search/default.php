		...
		<?php
			...
			if ($button) {
				if ($imagebutton) {
					...
					$button = '<input value="'.$button_text.'" class="button search-button '.$moduleclass_sfx.'" ' . $img .' onclick="this.form.searchword.focus();"/>';
				}
				else {
					$button = '<input type="submit" value="'.$button_text.'" class="button search-button '.$moduleclass_sfx.'" onclick="this.form.searchword.focus();"/>';
				}
